...
public class StyledPillButton extends JButton {
        ...
        private Color baseBg = new Color(255, 250, 240); 
        private Color hoverBg = new Color(255, 240, 200); 
        private Color pressedBg = new Color(200, 180, 150); 

        private Color borderColor = new Color(30, 40, 70); 
    ...
    public StyledPillButton(String text) {
        ...
        setForeground(new Color(20, 40, 90)); 
    ...
    protected void paintComponent(Graphics g) {
        ...
        // text shadow
        g2.setColor(new Color(10, 25, 60, 120)); 
